...
ActiveRecord::Schema.define(version: 2020_11_15_014314) do
  ...
  create_table "carts", force: :cascade do |t|
    ...
    t.index ["buyer_id_id"], name: "index_carts_on_buyer_id_id"
  ...
  add_foreign_key "carts", "users", column: "buyer_id_id"
